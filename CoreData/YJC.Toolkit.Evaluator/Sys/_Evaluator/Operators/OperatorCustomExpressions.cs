...
namespace YJC.Toolkit.Sys.Evaluator
{
    internal class OperatorCustomExpressions
    {
        ...
        /// <returns></returns>
        public static Expression MemberAccess(bool isFunction, bool isCall, Expression le,
            string membername, List<Expression> args)
        {
            ...
            TkDebug.ThrowToolkitException(string.Format(ObjectUtil.SysCulture,
                "成员没有找到: {0}.{1}", le.Type.Name, membername), null);
            return null;
        }
        ...
        {
            return Expression.Call(typeof(Convert), "ToString", null,
                instance, Expression.Constant(CultureInfo.InvariantCulture));
        }
