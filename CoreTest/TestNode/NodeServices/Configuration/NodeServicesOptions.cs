...
namespace Microsoft.AspNetCore.NodeServices
{
    ...
    public class NodeServicesOptions
    {
        ...
        /// <summary>
        /// Specifies how to construct Node.js instances. An <see cref="INodeInstance"/>
        /// encapsulates all details about how Node.js instances are launched and communicated with.
        /// A new <see cref="INodeInstance"/> will be created automatically if the previous instance
        /// has terminated (e.g., because a source file changed).
        /// </summary>
        public Func<INodeInstance> NodeInstanceFactory { get; set; }

        /// <summary>
        /// If set, overrides the path to the root of your application. This path is used when
        /// locating Node.js modules relative to your project.
        /// </summary>
        public string ProjectPath { get; set; }

        /// <summary>
        /// If set, the Node.js instance should restart when any matching file on disk within your
        /// project changes.
        /// </summary>
        ...
        /// <summary>
        /// If <see cref="LaunchWithDebugging"/> is true, the Node.js instance will listen for V8
        /// debugger connections on this port.
        /// </summary>
        ...
        /// <summary>
        /// Specifies the maximum duration, in milliseconds, that your .NET code should wait for
        /// Node.js RPC calls to return.
        /// </summary>
