...
(function ($) {
    ...
    Toolkit.list._checkAll = function () {
        var isChecked = this.checked;
        var checks = $(".list-checkbox");
    ...
    Toolkit.list._initPage = function (elm) {
        ...
        $("[name=jumpPage]").click(function () {
            var num = $(this).parents(".input-group").find("[name=jumpPageNum]").val();
            Toolkit.list._loadPageByPage(parseInt(num) - 1);
        });
        ...
        $("#chkAll").click(Toolkit.list._checkAll);
    ...
    Toolkit.list.exportExcel = function (elm) {
        ...
        listParams.Page = 0;
        var url = Toolkit.page.getAbsoluteUrl("c/excel/list/" + listView.attr("data-source"));
    ...
    Toolkit.list.tabCount = function (elm) {
        ...
        if (tabCountData && tabCountData != "") {
            ...
            var url = Toolkit.page.getAbsoluteUrl("c/xml/CTabCount/" + source);
