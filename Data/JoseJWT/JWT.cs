...
namespace YJC.Toolkit.JWT
{
    ...
    public static class JWT
    {
        ...
        /// <summary> Parses JWT token, extracts and unmarshal headers as IDictionary<string,
        /// object>. This method is NOT performing integrity checking. </summary> <param
        /// name="token">signed JWT token</param> <param name="settings">optional settings to
        /// override global DefaultSettings</param> <returns>unmarshalled headers</returns>
        ...
        /// <summary>
        /// Parses JWT token, extracts and attempts to unmarshal headers to requested type This
        /// method is NOT performing integrity checking.
        /// </summary>
        ...
        /// <summary>
        /// Parses signed JWT token, extracts and returns payload part as string This method is NOT
        /// supported for encrypted JWT tokens. This method is NOT performing integrity checking.
        /// </summary>
        /// <param name="token">signed JWT token</param>
        /// <param name="settings">optional settings to override global DefaultSettings</param>
        ...
        /// <summary>
        /// Parses signed JWT token, extracts payload part and attempts to unmarshal string to
        /// requested type with configured json mapper. This method is NOT supported for encrypted
        /// JWT tokens. This method is NOT performing integrity checking.
        /// </summary>
        /// <typeparam name="T">desired type after unmarshalling</typeparam>
        /// <param name="token">signed JWT token</param>
        /// <param name="settings">optional settings to override global DefaultSettings</param>
        ...
        /// <summary>
        /// Encodes given json string to JWT token and applies requested encryption/compression
        /// algorithms. Json string to encode will be obtained via configured IJsonMapper implementation.
        /// </summary>
        ...
        /// <param name="settings">optional settings to override global DefaultSettings</param>
        /// <returns>JWT in compact serialization form, encrypted and/or compressed.</returns>
        public static string Encode(string payload, object key, JweAlgorithm alg, JweEncryption enc, JweCompression? compression = null, IDictionary<string, string> extraHeaders = null, JwtSettings settings = null)
        {
        ...
        public static string EncodeBytes(byte[] payload, object key, JweAlgorithm alg, JweEncryption enc, JweCompression? compression = null, IDictionary<string, string> extraHeaders = null, JwtSettings settings = null)
        {
            ...
            IDictionary<string, string> jwtHeader = new Dictionary<string, string> { { "alg", jwtSettings.JwaHeaderValue(alg) }, { "enc", jwtSettings.JweHeaderValue(enc) } };
        ...
        /// <summary>
        /// Serialize and encodes object to JWT token and sign it using given algorithm. Json string
        /// to encode will be obtained via configured IJsonMapper implementation.
        /// </summary>
        ...
        /// verification as defined in JWT token header. Resulting json string is returned untouched
        /// (e.g. no parsing or mapping)
        /// </summary>
        ...
        /// <summary>
        /// Decodes JWT token by performing necessary decompression/decryption and signature
        /// verification as defined in JWT token header. Resulting bytes of the payload are returned
        /// untouched (e.g. no parsing or mapping)
        /// </summary>
        /// <param name="token">JWT token in compact serialization form.</param>
        /// <param name="key">key for decoding suitable for JWT algorithm used.</param>
        /// <param name="alg">The algorithm type that we expect to receive in the header.</param>
        ...
        /// <summary>
        /// Decodes JWT token by performing necessary decompression/decryption and signature
        /// verification as defined in JWT token header. Resulting binary payload is returned
        /// untouched (e.g. no parsing or mapping)
        /// </summary>
        /// <param name="token">JWT token in compact serialization form.</param>
        /// <param name="key">key for decoding suitable for JWT algorithm used, can be null.</param>
    ...
    internal class JoseException : Exception
    {
    ...
    internal class IntegrityException : JoseException
    {
    ...
    internal class EncryptionException : JoseException
    {
    ...
    internal class InvalidAlgorithmException : JoseException
    {
