...
{
    /// <summary>
    /// JWT settings object. JWT has a global DefaultSettings instance that can be used to set
    /// global defaults. Additionally, every method in JWT supports adding an optional settings
    /// parameter to override the default settings just for that call.
    /// </summary>
    public class JwtSettings
    {
        ...
        /// <summary>
        /// Register an alias for the "alg" header that should point to a standard JWA key
