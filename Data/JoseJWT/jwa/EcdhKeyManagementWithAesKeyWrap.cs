...
{
    internal class EcdhKeyManagementWithAesKeyWrap : EcdhKeyManagement
    {
        ...
        public override byte[][] WrapNewKey(int cekSizeBits, object key, IDictionary<string, string> header)
        {
