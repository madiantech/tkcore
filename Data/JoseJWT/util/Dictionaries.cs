...
namespace YJC.Toolkit.JWT
{
    ...
    {
        /// <summary>
        /// Appends `other` key/value pairs to 'src'. Conflicting keys are not appended (e.g. 'src'
        /// keys has priority). Operation in mutable, 'src' modified as result. Null safe operation.
        /// </summary>
