...
{
    public class DbDetailListSource : DbListSource
    {
        private readonly TableResolver fMasterResolver;
        private readonly ChildTableInfo fChildInfo;
        //public DbDetailListSource()
        //{
        //}

        public DbDetailListSource(IBaseDbConfig config, IConfigCreator<TableResolver> mainResolver,
        ...
        internal DbDetailListSource(DbDetailListSourceConfig config,
