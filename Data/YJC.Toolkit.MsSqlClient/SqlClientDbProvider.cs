...
namespace YJC.Toolkit.Data
{
    [CacheInstance]
    [AlwaysCache]
    [DbProvider(RegName = REG_NAME, Author = "YJC", CreateDate = "2019-11-09", Description = DESCRIPTION)]
    internal sealed class SqlClientDbProvider : IDbProvider
    {
        internal const string REG_NAME = "MS SQL Server";
        internal const string DESCRIPTION = "Microsoft SqlClient数据库连接提供者";
