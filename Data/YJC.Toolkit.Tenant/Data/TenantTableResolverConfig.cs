...
namespace YJC.Toolkit.Data
{
    [ResolverCreatorConfig(NamespaceType = NamespaceType.Toolkit, Author = "YJC", CreateDate = "2018-05-22",
        Description = "在Tk5的DataXml基础上，支持Tenant的TableResolver")]
    [ObjectContext]
    internal class TenantTableResolverConfig : IConfigCreator<TableResolver>
    {
        ...
        public TableResolver CreateObject(params object[] args)
        {
            ...
            return new TenantTableResolver(dataXml, source)
            {
