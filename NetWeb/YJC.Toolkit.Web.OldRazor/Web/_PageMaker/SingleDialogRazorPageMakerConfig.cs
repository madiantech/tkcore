...
{
    [PageMakerConfig(Description = "单表新建，修改，删除等综合的RazorPageMaker，新建修改等操作为Dialog界面",
        NamespaceType = NamespaceType.Toolkit, Author = "YJC", CreateDate = "2014-08-06")]
    class SingleDialogRazorPageMakerConfig : BaseSingleRazorPageMakerConfig
    {
        ...
        {
            return base.CreateDetailPageMaker(config, pageData);
        }
