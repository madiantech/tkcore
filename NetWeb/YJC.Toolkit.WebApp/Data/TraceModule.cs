...
namespace YJC.Toolkit.Data
{
    ...
    internal class TraceModule : BaseCustomModule
    {
        ...
        private const string FACTORYMAKER = "<FreeRazorPageMaker RazorFile=\"razortemplate"
            + "/BootCss/Bin/FactoryDetail.cshtml\"/>";

        private const string CONFIGMAKER = "<FreeRazorPageMaker RazorFile=\"razortemplate"
            + "/BootCss/Bin/ConfigDetail.cshtml\"/>";
